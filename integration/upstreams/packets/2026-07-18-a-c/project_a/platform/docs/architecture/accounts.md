...
| Live lab account `000000000000` / `us-east-1` | **APPLIED** / cloud-validated — collapsed identity + network + audit via GitHub OIDC CI ([run 29366105164](https://github.com/nathanielecon/cloud/actions/runs/29366105164), role `project-a-lzlab-gha`); see [`EVIDENCE.md`](../../sandbox/landing-zone-lab/EVIDENCE.md) |
...
In account `000000000000`, the Landing Zone lab collapses identity, private
