...
# Reuses the account GitHub OIDC provider (token.actions.githubusercontent.com).
...
# Standalone ContinuityOps repository (not aws-landing-zone-lab).
...
variable "github_repository_id" {
  type        = string
  default     = "1301990908"
  description = "GitHub repository_id for nathanielecon/ContinuityOps; survives renames. Do not use aws-landing-zone-lab id 1296742987."
}
