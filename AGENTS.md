...
- Live ContinuityOps AWS = **GitHub OIDC → `arn:aws:iam::283077380808:role/continuityops-gha`**
...
- Durable state: `terraform/ci-bootstrap/ensure-tfstate.sh` then S3 backend
  (`continuityops-tfstate-283077380808` / `continuityops-tf-locks`).
...
`arn:aws:iam::283077380808:root`. ContinuityOps CI role:
`arn:aws:iam::283077380808:role/continuityops-gha`. See BF-2026-010 + Live AWS.
