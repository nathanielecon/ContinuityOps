...
| --- | --- | --- |
| IAM role `continuityops-gha` | LIVE | `arn:aws:iam::283077380808:role/continuityops-gha` |
...
| Remote state | LIVE | bucket `continuityops-tfstate-283077380808`, lock `continuityops-tf-locks` |
...
- Account (not secret): `283077380808`
