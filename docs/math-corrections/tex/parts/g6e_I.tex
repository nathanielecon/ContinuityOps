...
\blockhead{Question}
Write an equivalent way to express $6 < y$:\ \blank[2.4cm]
...
\begin{steps}
  ...
  \item Put an arrow on the shaded part to show it keeps going.
        ...
        \begin{tikzpicture}[x=0.62cm,y=0.62cm]
          \draw[{Stealth[length=2.4mm]}-{Stealth[length=2.4mm]}] (3.3,0) -- (8.7,0);
          \foreach \x in {4,5,...,8}{%
            \draw (\x,0.16) -- (\x,-0.16);
            \node[below=1pt,font=\footnotesize] at (\x,-0.16) {$\x$};}
          \draw[blue,very thick,-{Stealth[length=2.6mm]}] (6,0) -- (8.1,0);
...
\begin{steps}
  ...
  \item Add an arrow to show the shading continues forever.
        \begin{center}
        \begin{tikzpicture}[x=0.62cm,y=0.62cm]
          \draw[{Stealth[length=2.4mm]}-{Stealth[length=2.4mm]}] (-0.7,0) -- (5.7,0);
          \foreach \x in {0,1,...,5}{%
            \draw (\x,0.16) -- (\x,-0.16);
            \node[below=1pt,font=\footnotesize] at (\x,-0.16) {$\x$};}
          \draw[blue,very thick,-{Stealth[length=2.6mm]}] (2,0) -- (5.1,0);
...
\blockhead{Why this makes sense}
Numbers like 3, 4 and 5 are shaded, and the arrow shows that larger numbers
such as 10 and 100 are included too. The number 2 itself is not shaded.
...
\blockhead{Question}
Rectangle with length $9$ and width $4$: Area $= $\ansblank
...
\blockhead{Question}
Rectangle with length $11$ and width $3$: Perimeter $= $\ansblank
...
\blockhead{Question}
Rectangle with area $42$ sq units and width $6$: Length $= $\ansblank
