...
\blockhead{Question}
Graph $6 < y$ on the number line below.
\blanknumline{0}{12}{2}
...
\begin{steps}
  ...
  \item Put an arrow on the shaded part to show it keeps going.
        ...
        \begin{tikzpicture}[x=0.62cm,y=0.62cm]
          \draw (-0.7,0) -- (12.7,0);
          \draw[-{Stealth[length=2.4mm]}] (12,0) -- (12.7,0);
          \foreach \x in {0,2,...,12}{%
            \draw (\x,0.16) -- (\x,-0.16);
            \node[below=1pt,font=\footnotesize] at (\x,-0.16) {$\x$};}
          \draw[blue,very thick,-{Stealth[length=2.6mm]}] (6,0) -- (12.6,0);
...
\blockhead{Question}
Graph $x > 2$ on the number line below.
\blanknumline{-2}{10}{2}
...
\begin{steps}
  ...
  \item Add an arrow to show the shading continues forever.
        ...
        \begin{tikzpicture}[x=0.62cm,y=0.62cm]
          \draw (-2.7,0) -- (10.7,0);
          \draw[-{Stealth[length=2.4mm]}] (10,0) -- (10.7,0);
          \foreach \x in {-2,0,...,10}{%
            \draw (\x,0.16) -- (\x,-0.16);
            \node[below=1pt,font=\footnotesize] at (\x,-0.16) {$\x$};}
          \draw[blue,very thick,-{Stealth[length=2.6mm]}] (2,0) -- (10.6,0);
...
\blockhead{Question}
Rectangle: length $9$, width $4$. Area $= $
...
\blockhead{Question}
Rectangle: length $11$, width $3$. Perimeter $= $
...
\blockhead{Question}
Rectangle: area is $42$ square units and width is $6$. Length $= $
...
\blockhead{Question}
$210$ miles $\div$ $3$ hours $= $\ansblank\ miles per hour
...
\blockhead{Question}
$150$ miles $\div$ $5$ gallons $= $\ansblank\ miles per gallon
