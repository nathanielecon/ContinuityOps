...
\begin{tikzpicture}[y=0.011cm,x=1cm]
  ...
  % ticks and labels
  \foreach \y/\lab in {450/$450$, 225/$225$, 0/sea level: $0$, -120/$-120$, -200/$-200$}{%
    \draw (-0.08,\y) -- (0.08,\y);
    \node[right=2pt,font=\footnotesize] at (0.08,\y) {\lab};}
  % marked points
  ...
  \draw[teal,dotted] (0.75,450) -- (2.35,450);
  \draw[teal,dotted] (0.75,-120) -- (2.35,-120);
\end{tikzpicture}
\end{center}
