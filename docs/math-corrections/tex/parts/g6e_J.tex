...
\blockhead{Question}
Is $8x + 1$ a linear expression?\ \blank[2.4cm]
...
\blockhead{Question}
Prime factorization of $90 = $\ansblank
...
\blockhead{Question}
Find the GCF of $27$ and $36$:\ \blank[2.4cm]
...
\blockhead{Question}
Convert $\mixed{2}{2}{3}$ to an improper fraction:\ \blank[2.4cm]
...
\begin{words}
  ...
  \item An \term{improper fraction}has a numerator greater than or equal to the denominator, like $\tfrac{8}{3}$.
...
\begin{steps}
  ...
  \item Keep denominator 3: $\tfrac{8}{3}$.
\end{steps}
...
\blockhead{Question}
Which is greater: $\mixed{1}{3}{4}$ or $(1)\!\left(\tfrac{3}{4}\right)$?\ \blank[2.4cm]
...
\blockhead{Important words}
\begin{words}
  \item $\mixed{1}{3}{4}$ means $1 + \tfrac{3}{4}$.
  \item $(1)\!\left(\tfrac{3}{4}\right)$ means 1 times $\tfrac{3}{4}$, which is just $\tfrac{3}{4}$.
  \item Parentheses next to each other mean multiply.
\end{words}

\blockhead{Work the problem one tiny step at a time}
\begin{steps}
  \item Rewrite the mixed number: $\mixed{1}{3}{4} = 1 + \tfrac{3}{4} = \tfrac{4}{4} + \tfrac{3}{4} = \tfrac{7}{4}$.
  \item Compute the product: $(1)\!\left(\tfrac{3}{4}\right) = \tfrac{3}{4}$.
  \item Compare $\tfrac{7}{4}$ and $\tfrac{3}{4}$. Same denominator, so compare tops: $7 > 3$.
...
\blockhead{Work the problem one tiny step at a time}
\begin{steps}
  \item Rewrite $\tfrac{m}{2}$ as $\tfrac{1}{2}m$.
  \item The number multiplying $m$ is $\tfrac{1}{2}$.
  \item So the coefficient of $m$ is $\tfrac{1}{2}$.
\end{steps}
...
\blockhead{Work the problem one tiny step at a time}
\begin{steps}
  \item Start with $\tfrac{q}{5}$.
  \item Rewrite dividing by 5 as multiplying by $\tfrac{1}{5}$: $\tfrac{q}{5} = \tfrac{1}{5}q$.
  \item The number multiplying $q$ is $\tfrac{1}{5}$.
  \item So the coefficient is $\tfrac{1}{5}$.
  \item Numeric check: if $q = 10$, then $\tfrac{10}{5} = 2$ and $\tfrac{1}{5} \times 10 = 2$. Same value, so $\tfrac{1}{5}$ really is the multiplier.
\end{steps}
