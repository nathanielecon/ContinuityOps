...
\blockhead{What the question is asking}
This question asks you to shrink $\dfrac{27}{36}$ by dividing the top and bottom by the same whole number until nothing bigger than 1 divides both evenly.
...
\blockhead{Why this makes sense}
Check: $\dfrac{8}{3} = 2 + \dfrac{2}{3}$ because $\dfrac{6}{3} = 2$ and $\dfrac{2}{3}$ remains. Same mixed number.
...
\blockhead{Why this makes sense}
A mixed number includes a whole 1 plus a fraction. Multiplying by 1 does not add a whole; it only keeps $\dfrac{3}{4}$. So the mixed number is larger.

\question{K7}

\blockhead{Question}
In $\dfrac{m}{2}$, the coefficient of $m$ is \blank[1.8cm].

\checked{$\dfrac{1}{2}$}

\blockhead{What the question is asking}
This question asks for the number that multiplies the letter $m$ in $\dfrac{m}{2}$.

\blockhead{Important words}
\begin{words}
  \item A \term{coefficient}is the number multiplying a variable.
  \item $\dfrac{m}{2}$ means $m$ divided by 2, which is the same as $\dfrac{1}{2} \times m$.
\end{words}
...
\blockhead{Why this makes sense}
Dividing by 2 is the same as multiplying by one-half. The coefficient is not 2; it is $\dfrac{1}{2}$.

\question{K8}

\blockhead{Question}
In $\dfrac{q}{5}$, the coefficient of $q$ is \blank[1.8cm].

\checked{$\dfrac{1}{5}$}

\blockhead{What the question is asking}
This question asks for the number that multiplies the letter $q$ in $\dfrac{q}{5}$.
...
\begin{words}
  ...
  \item A \term{fraction}$\dfrac{q}{5}$ means $q$ divided by 5.
  \item Dividing by 5 is the same as multiplying by $\dfrac{1}{5}$: $\dfrac{q}{5} = \dfrac{1}{5} \times q$.
\end{words}
...
\blockhead{Why this makes sense}
Dividing by 5 means multiplying by $\dfrac{1}{5}$. The coefficient is that multiplier. Check with $q = 10$: both forms give 2.

\question{K9}

\blockhead{Question}
Rewrite using the commutative property: $8 + 5 = $
...
\blockhead{Question}
Rewrite using the commutative property: $7 \times a = $
...
\blockhead{Question}
Rewrite using the associative property: $(b + 3) + 9 = $
