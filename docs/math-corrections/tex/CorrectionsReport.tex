...
{\normalsize Five-document 7th-grade mathematics set \quad$\cdot$\quad 10 parallel scanners, page-by-page against the rendered PDFs}
\end{center}
\vspace{0.6em}
...
Topic 1 --- Explanations companion (Part 1) & 1 & 12 & 33 & 46\\
Topic 1 --- Part 1 Solutions & 4 & 2 & 9 & 15\\
Topic 1 --- Part 2 Solutions & 0 & 10 & 1 & 11\\
6th Grade Review (worksheet) & 0 & 5 & 7 & 12\\
6th Grade Review --- Explanations companion & 1 & 10 & 25 & 36\\
\midrule
\textbf{Total} & \textbf{6} & \textbf{39} & \textbf{75} & \textbf{120}\\
\bottomrule\end{tabular}\end{center}
\medskip\noindent\textbf{By category:} inconsistency (46), formatting (22), grammar (19), notation (15), math (8), punctuation (5), spacing (5).
...
\medskip\noindent\textbf{Also checked and found sound.} All arithmetic in all
five documents was recomputed independently: the 24 exponent-law items across
both keys, the mixed-number conversions, the butterfly cross-products, and all
69 checked answers in the 6th Grade Review companion. Only the items listed
below were wrong. Section lettering A--N is complete and sequential, and the
worksheet maps 1:1 onto its companion with no orphans in either direction.
...
\subsection*{High severity (1)}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~2} \quad \sevhigh{High} \quad \textit{inconsistency}\par
\noindent\textbf{Where: }Topic 1-1 Question 1 > Question block + Checked answer (mismatch continues onto p.3)\par
\noindent\textbf{Found: }\textit{A submarine rises 18 meters from a point below sea level, then descends 18 meters. Part A: Represent both changes with signed numbers and find their sum. Part B: Explain why the two changes are additive inverses. Checked answer: +18 + ($-$18) = 0; equal magnitude and opposite signs.}\par
\noindent\textbf{Corrected to: }Question: A climber climbs 4.5 meters up. Name the move that is the additive inverse of that climb and explain why the two moves add to zero. Checked answer: $-$4.5 meters (4.5 meters downward); +4.5 + ($-$4.5) = 0.\par
\noindent\textbf{Why: }Every other block of this question is about a 4.5 m climb --- 'What the question is asking' ("undoes a climb of 4.5 meters"), the Important words bullet "A climb of 4.5 meters means moving up 4.5 meters", steps 1--5 ("+4.5 meters (up)", "the inverse move is $-$4.5 meters", "Check: +4.5 + ($-$4.5) = 0"), and "Final answer: 4.5 meters downward", which is exactly what Topic1Part1Solutions gives ("Answer: 4.5 meters downward"); the submarine/18-meter stem and its Checked answer are the odd ones out, and the p.3 'Why this makes sense' line ("The rise and descent cancel") is left describing the wrong scenario as well.\par\vspace{4pt}
...
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~10} \quad \sevlow{Low} \quad \textit{inconsistency}\par
\noindent\textbf{Where: }Section heading above Question 1 of the SC-1 lesson\par
\noindent\textbf{Found: }\textit{Lesson SC-1: Compare Rational Numbers}\par
\noindent\textbf{Corrected to: }Topic SC-1 Compare Rational Numbers\par
\noindent\textbf{Why: }Every other section heading in the companion uses the pattern "Topic 1-N Title" with no colon ("Topic 1-1 Relate Integers and Opposites", "Topic 1-2 Understand Rational Numbers", "Topic 1-3 Add Integers"), and the answer key names the later supporting-cluster section "Topic SC-2 Use the Laws of Exponents", so "Lesson" plus a colon is a one-off.\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
...
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~40} \quad \sevlow{Low} \quad \textit{formatting}\par
\noindent\textbf{Where: }Topic SC-2 section heading\par
\noindent\textbf{Found: }\textit{Topic SC-2: Use the Laws of Exponents}\par
\noindent\textbf{Corrected to: }Topic SC-2 Use the Laws of Exponents\par
\noindent\textbf{Why: }Every other topic heading in the companion (e.g. "Topic 1-9 Divide Rational Numbers" on p.35, "Topic 1-10 Solve Problems with Rational Numbers" on p.38) omits the colon, as does the matching heading in Topic1Part1Solutions.\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
...
\subsection*{Low severity (9)}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~1} \quad \sevlow{Low} \quad \textit{grammar}\par
\noindent\textbf{Where: }subtitle line under the document title\par
\noindent\textbf{Occurrences: }Part 1 p.1 and Part 2 p.1 (identical subtitle)\par
\noindent\textbf{Found: }\textit{Brief checks. Use We Need $\to$ We Know $\to$ We Solve on your notebook.}\par
\noindent\textbf{Corrected to: }Brief checks. Use We Need $\to$ We Know $\to$ We Solve in your notebook.\par
\noindent\textbf{Why: }Work is done "in" a notebook, not "on" one.\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
...
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~2} \quad \sevlow{Low} \quad \textit{inconsistency}\par
\noindent\textbf{Where: }section headings: "Lesson SC-1 ..." vs "Topic SC-2 ..."\par
\noindent\textbf{Occurrences: }Part 1 p.2 (Lesson SC-1) vs p.5 (Topic SC-2); Part 2 p.1 (Lesson SC-1) vs p.5 (Topic SC-2)\par
\noindent\textbf{Found: }\textit{Lesson SC-1 Compare Rational Numbers}\par
\noindent\textbf{Corrected to: }Topic SC-1 Compare Rational Numbers\par
\noindent\textbf{Why: }Every other section heading in both documents begins "Topic"; only the SC-1 heading uses "Lesson", so the two supplementary lessons are labelled with different words.\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
...
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~1} \quad \sevmed{Medium} \quad \textit{math}\par
\noindent\textbf{Where: }Topic 1-2 Question 2 > We Know\par
\noindent\textbf{Found: }\textit{We Know: A fraction decimal terminates or repeats.}\par
\noindent\textbf{Corrected to: }We Know: A fraction (with nonzero denominator) becomes a decimal that terminates or repeats.\par
\noindent\textbf{Why: }Part 2 drops the "(with nonzero denominator)" qualifier that Part 1 carries --- the claim is false without it --- and "A fraction decimal" is ungrammatical (missing verb/possessive).\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~1} \quad \sevmed{Medium} \quad \textit{inconsistency}\par
\noindent\textbf{Where: }Topic 1-2 Question 2 > We Solve / Answer\par
\noindent\textbf{Found: }\textit{We Solve: B is always right.}\par
\noindent\textbf{Corrected to: }We Solve: B is not right. (or restore a "We Need:" line stating exactly what the item asks)\par
\noindent\textbf{Why: }Part 1's parallel item asks which statement is NOT right and answers "C is not right"; Part 2 has no We Need line and flips to an "always right" claim, which the preceding We Know line does not establish (a fraction's decimal may terminate instead of repeating), so the reader cannot tell whether B is the correct selection.\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~1} \quad \sevmed{Medium} \quad \textit{inconsistency}\par
...
\subsection*{Medium severity (5)}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~1} \quad \sevmed{Medium} \quad \textit{inconsistency}\par
\noindent\textbf{Where: }Section D item 4 (p.1) and Section M item 6 (p.4)\par
\noindent\textbf{Occurrences: }D4 (p.1, answer 7) and M6 (p.4, answer 9)\par
\noindent\textbf{Found: }\textit{4. 5.6 $\div$ 0.8 = (decimal)}\par
\noindent\textbf{Corrected to: }5.6 $\div$ 0.8 = \_\_\_\_\_\_\_\_\_\_\_\_\par
\noindent\textbf{Why: }Both items are tagged "(decimal)" but their answers are whole numbers (7 and 9), and the companion's checked answers are plainly "7" and "9", so the tag contradicts the accepted answer and invites a student to write "7.0".\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~1} \quad \sevmed{Medium} \quad \textit{inconsistency}\par
\noindent\textbf{Where: }Directions line, versus items A1, H6, H7 and all fill-in items\par
\noindent\textbf{Occurrences: }Directions (p.1); affected items A1 (p.1), H6 and H7 (p.2)\par
\noindent\textbf{Found: }\textit{Show work in the space provided or on scrap paper as directed.}\par
\noindent\textbf{Corrected to: }Show work on scrap paper.\par
\noindent\textbf{Why: }No work space is provided anywhere on the four pages --- the items are set as tightly spaced lists --- and A1, H6 and H7 ask the student to plot or graph on a number line that is never printed, so the promised "space provided" does not exist.\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
...
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~3} \quad \sevmed{Medium} \quad \textit{inconsistency}\par
\noindent\textbf{Where: }Section K item 10 (p.3) and Section N item 5 (p.4)\par
\noindent\textbf{Occurrences: }K10 (p.3) and N5 (p.4) --- exact duplicate pair; the neighbouring associative items K11 "(b + 3) + 9" and N6 "(x + 5) + 8" are NOT duplicates (different letters and numbers), and K9 "8 + 5" is unique.\par
\noindent\textbf{Found: }\textit{10. Rewrite using the commutative property: 7 $\times$ a =}\par
\noindent\textbf{Corrected to: }Delete N5, or change one of the two to a different instance, e.g. N5: "Rewrite using the commutative property: 9 $\times$ b ="\par
\noindent\textbf{Why: }K10 and N5 are character-for-character the same item, so the student answers the identical prompt twice and the companion carries two identical worked explanations (K10 and N5 both "Checked answer: a $\times$ 7").\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~4} \quad \sevmed{Medium} \quad \textit{formatting}\par
\noindent\textbf{Where: }Sections C, D, M, N --- the answer-format tag on every computation item\par
\noindent\textbf{Occurrences: }C2, C3, D3, D4, M1--M6, N1--N4 (14 items across pp.1, 4)\par
\noindent\textbf{Found: }\textit{1. 428.5 + 37.26 = (decimal)}\par
\noindent\textbf{Corrected to: }428.5 + 37.26 = \_\_\_\_\_\_\_\_\_\_\_\_ (decimal)\par
\noindent\textbf{Why: }The format hint sits in the answer position with no answer blank, so the line reads as an equation whose right-hand side is the literal word "(decimal)" rather than as a fill-in with a format note.\par\vspace{4pt}
\subsection*{Low severity (7)}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~1} \quad \sevlow{Low} \quad \textit{punctuation}\par
\noindent\textbf{Where: }Section C item 1\par
\noindent\textbf{Occurrences: }C1 only\par
\noindent\textbf{Found: }\textit{1. In 82.731, the tenths digit is \_\_\_\_\_\_\_\_\_\_}\par
\noindent\textbf{Corrected to: }1. In 82.731, the tenths digit is \_\_\_\_\_\_\_\_\_\_.\par
\noindent\textbf{Why: }This is the only full-sentence fill-in on the worksheet with no terminal period; the structurally identical items F1, F2, F3, F4, K7 and K8 all end with a period after the blank.\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~1} \quad \sevlow{Low} \quad \textit{formatting}\par
\noindent\textbf{Where: }All fourteen section headings A--N\par
\noindent\textbf{Occurrences: }B "Order Of Operations", C "Decimals, Fractions, And Percents", D "Facts And Decimal Multiply/Divide", E "Ratios, Fractions, And Proportions", F "Vocabulary, Expressions, And Equations", H "Equations, Inequalities, And Graphing", J "Units And Quantities", K "Expressions, Factors, And Fraction Structure", L "Distributive Property And Factoring", N "Fraction Operations And Properties"\par
\noindent\textbf{Found: }\textit{B. Order Of Operations}\par
\noindent\textbf{Corrected to: }B. Order of Operations\par
\noindent\textbf{Why: }Every heading capitalises the short function words ("Of", "And"), the signature of a mechanical title-casing pass rather than a deliberate style, and it reads wrong in a student-facing document.\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~1} \quad \sevlow{Low} \quad \textit{inconsistency}\par
\noindent\textbf{Where: }Section D items 3--4 versus Section M items 5--6\par
\noindent\textbf{Occurrences: }D3/M5 and D4/M6\par
\noindent\textbf{Found: }\textit{3. 2.4 $\times$ 1.5 = (decimal)}\par
\noindent\textbf{Corrected to: }Drop D3/D4 or M5/M6, or vary the operand shape (e.g. M5: 4.2 $\times$ 0.25 =)\par
\noindent\textbf{Why: }D3/D4 and M5/M6 are the same two skills with digit-swapped operands (2.4 $\times$ 1.5 vs 4.2 $\times$ 1.5; 5.6 $\div$ 0.8 vs 7.2 $\div$ 0.8), which is redundant in a diagnostic that is otherwise one item per skill.\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~2} \quad \sevlow{Low} \quad \textit{inconsistency}\par
...
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~2} \quad \sevlow{Low} \quad \textit{grammar}\par
\noindent\textbf{Where: }Section E item 1, versus Section K item 6\par
\noindent\textbf{Occurrences: }E1 (p.2) vs K6 (p.3)\par
\noindent\textbf{Found: }\textit{1. Greater: or 0.61? [the blank is a built-up fraction five-eighths]}\par
\noindent\textbf{Corrected to: }1. Which is greater: [five-eighths] or 0.61?\par
\noindent\textbf{Why: }E1 is a telegraphic fragment punctuated as a question, while the identical task type at K6 is written as a full question ("Which is greater: \ldots?").\par\vspace{4pt}
\needspace{5\baselineskip}
\noindent\rule{\textwidth}{0.4pt}\par\nobreak\vspace{2pt}
\noindent\textbf{p.~3} \quad \sevlow{Low} \quad \textit{notation}\par
\noindent\textbf{Where: }Section J items 3 and 5\par
\noindent\textbf{Occurrences: }J3 and J5 (p.3)\par
\noindent\textbf{Found: }\textit{3. 210 miles / 3 hours =}\par
\noindent\textbf{Corrected to: }3. 210 miles $\div$ 3 hours = \_\_\_\_\_\_\_\_\_\_ miles per hour\par
\noindent\textbf{Why: }These are the only two division items written with a slash rather than $\div$ or a set fraction, and neither asks for the unit that the companion's checked answers supply ("70 miles per hour", "30 miles per gallon"), unlike J1 and J4 which do print the unit after the blank.\par\vspace{4pt}
