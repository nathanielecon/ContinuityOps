...
0. **READ `DESIGN_SPEC.md` FIRST.** Explanation companions use *variant C*
   numbers — distinct from Independent Practice Part 1 AND Part 2. Transcribing
   Part 1's numbers into an explanation is a defect, not fidelity. Rule 1 below
   governs everything EXCEPT the numbers, which rule 0 governs.
