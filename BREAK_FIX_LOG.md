...
- **Remaining risk/follow-up:** when elevating ContinuityOps S1–S7 to L4+, dispatch apply via `landing-zone-lab.yml` / ContinuityOps OIDC workflows or local bottleneck; return evidence to this repo.
